      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {settings.contact_content && (
          <motion.div
            ...
            className="bg-white/10 rounded-2xl shadow-lg p-6 mb-8 border border-green-500/20"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Other social links remain, but update their text and icon colors to green palette if present */}
            </div>
          </motion.div>
        </div>
      </div>
