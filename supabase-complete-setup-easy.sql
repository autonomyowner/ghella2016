-- Complete Supabase Setup for Elghella Marketplace
...
DROP POLICY IF EXISTS "Users can add own reviews" ON reviews;
...
DO $$
BEGIN
    RAISE NOTICE '🎉 Elghella Marketplace setup completed successfully!';
    ...
    RAISE NOTICE '✅ Storage buckets created: avatars, equipment-images, land-images, animal-images';
