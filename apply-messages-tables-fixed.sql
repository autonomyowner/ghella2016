-- =====================================================
-- Create Messages and Contact System Tables (FIXED)
-- =====================================================

-- 1. Contact Messages Table (General contact form messages)
...
-- 2. Expert Applications Table (For expert join requests)
...
-- 4. Admin Messages Table (For internal admin communication)
...
-- RLS Policies for contact_messages (FIXED - using is_verified instead of user_type)
...
SELECT '✅ Messages and contact system tables created successfully! (FIXED)' as status; 